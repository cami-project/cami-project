...
namespace DSS.FuzzyInference
{
    public class Loc
    {
        ...
        private static Dictionary<string, string> text = new Dictionary<string, string>(){
            ...
            //STEPS
            { EN + CAREGVR + MSG + STEPS_LESS_1000, "Low step count alert!" },
            { EN + CAREGVR + DES + STEPS_LESS_1000, "The person under your care has walked very few steps today. Call them to ask they move more." },
            { PL + CAREGVR + MSG + STEPS_LESS_1000, "Alert o małej liczbie kroków!" },
            { PL + CAREGVR + DES + STEPS_LESS_1000, "Osoba, którą się opiekujesz, zrobiła dziś niewielką liczbę kroków. Skontaktuj się z nią i poproś, żeby zrobiła ich więcej." },
            { RO + CAREGVR + MSG + STEPS_LESS_1000, "Alerta numar de pasi scazut!" },
            { RO + CAREGVR + DES + STEPS_LESS_1000, "Persoana in grija dvs. a facut un numar scazut de pasi astazi. Sunati pentru a o ruga sa fie mai activa." },
            { DK + CAREGVR + MSG + STEPS_LESS_1000, "Alarm - få skridt registreret!" },
            { DK + CAREGVR+ DES + STEPS_LESS_1000, "Vi har registreret et lavt aktivitetsniveau. Tag venligst kontakt og spørg ind." },

            { EN + USR + MSG + STEPS_BETWEEN_1000_2000, "Hey! Your number of steps for today is quite low: {0}" },
            { EN + USR + DES + STEPS_BETWEEN_1000_2000, "Why not take a short walk?" },
            { PL + USR + MSG + STEPS_BETWEEN_1000_2000, "Hej! Liczba kroków, które dziś zrobiłeś, jest dość mała: {0}" },
            { PL + USR + DES + STEPS_BETWEEN_1000_2000, "Co powiesz na krótki spacer?" },
            { RO + USR + MSG + STEPS_BETWEEN_1000_2000, "Buna! Numarul tau de pasi de azi e destul de scazut: {0}" },
            { RO + USR + DES + STEPS_BETWEEN_1000_2000, "Ce-ai zice de o scurta plimbare data viitoare?" },
            { DK + USR + MSG + STEPS_BETWEEN_1000_2000, "Hej. Antallet af skridt for i dag er temmeligt lavt: {0}" },
            { DK + USR + DES + STEPS_BETWEEN_1000_2000, "Hvorfor tager du ikke en kort gåtur ved lejlighed?" },

            { EN + USR + MSG + STEPS_BIGGER_6000, "Hey! Good job, today you made {0} steps." },
            { EN + USR + DES + STEPS_BIGGER_6000, "Today you made {0} steps! Keep it up!" },
            { PL + USR + MSG + STEPS_BIGGER_6000, "Hej! Brawo! Dziś zrobiłeś {0} kroków" },
