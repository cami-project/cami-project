...
wget --output-document=/var/www/html/wp-content/themes/theme/css/test.css https://raw.githubusercontent.com/cami-project/cami-project/master/website/assets/styles/styles-overrides-bundle.min.css 2>&1 | tee -a $HOME/deploy.log
