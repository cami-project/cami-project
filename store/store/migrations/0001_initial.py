# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2017-03-06 12:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backend_id', models.CharField(blank=True, max_length=64, null=True, unique=True)),
                ...
                ('activity_source', models.CharField(choices=[(b'self', b'self'), (b'doctor', b'doctor'), (b'caregiver', b'caregiver'), (b'recommendation', b'recommendation')], default=b'self', max_length=16)),
                ...
                ('last_postponed_time', models.DateTimeField(blank=True, null=True)),
